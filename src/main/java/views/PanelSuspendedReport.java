...
public class PanelSuspendedReport extends JPanel {
    ...
    private void initComponents(){
        ...
        scrollReport.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.decode("#204051")),
                "Procesos Suspendidos", TitledBorder.CENTER, TitledBorder.DEFAULT_POSITION, ConstantsGUI.FONT_TABLE_HEADER, Color.decode("#204051")));
